...
class CocrystalsMetrics:
    ...
    def unobstructed(self, generated_coformer):
    ...
    def orthogonal_planes(self, generated_coformer):
        clf_data, generated_coformers_clear = self.classifier.create_clf_dataframe(self.drug,
                                                                                   [generated_coformer])
    ...
    def h_bond_bridging(self, generated_coformer):
        clf_data, generated_coformers_clear = self.classifier.create_clf_dataframe(self.drug,
                                                                                   [generated_coformer])
