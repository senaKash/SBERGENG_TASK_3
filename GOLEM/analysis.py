...
def get_final_dataset(results_folder, drug):
    best_smiles = dict()
    adapter = MolAdapter()
    ...
    result = {'drug': [drug] * len(best_smiles), 'generated_coformers': [],
...
def visualize_results(feature_names, initial_molecules, golem_result, results_folder):
